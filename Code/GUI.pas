...
///  /////////////////////////Звук
  ...
  MyOList.Add(SetP3D(-18,37,1378),SetP3D(109,84,109),SetP3D(-90,0,90),23,14); /////////////dom

  MyOList.Add(SetP3D(-124,51,1323),SetP3D(165,77,146),SetP3D(-90,0,90),23,14); /////////////dom
  MyOList.Add(SetP3D(-195,42,1560),SetP3D(104,86,146),SetP3D(-90,0,0),23,14); /////////////dom
  MyOList.Add(SetP3D(-237,42,1476),SetP3D(104,95,146),SetP3D(-90,0,90),23,14); /////////////dom
  MyOList.Add(SetP3D(-237,42,1157),SetP3D(180,95,146),SetP3D(-90,0,90),23,14); /////////////dom
  MyOList.Add(SetP3D(-71,42,1081),SetP3D(85,97,119),SetP3D(-90,0,0),23,14); /////////////dom


  MyOList.Add(SetP3D(81,42,1197),SetP3D(108,132,100),SetP3D(-90,0,0),22,13); ///////////nauchniy centre
  ///
  ///
  ///
  ///
